...
public class RuleWrapCollections extends ClassOCRuleImpl {
	...
	private void searchNonWrapperUsage(Set<TypeDeclaration> wrapperTypes,
		...
		ViolationHandlerImpl instanceViolationHandler = new CollectionReturnViolationHandler(
				iUnit, unit, reporter);
	...
	private Set<TypeDeclaration> determineWrapperTypes(ICompilationUnit iUnit,
		...
		ViolationHandlerImpl instanceViolationHandler = new CollectionWrapperClassViolationHandler(
				iUnit, unit, reporter);
		WrapperVisitor visitor = new WrapperVisitor(instanceViolationHandler,
